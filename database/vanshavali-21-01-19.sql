...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 21, 2019 at 07:54 AM
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1 COMMENT='user master table for login';

--
-- Dumping data for table `user_master`
--

INSERT INTO `user_master` (`user_id`, `user_email`, `user_pass`, `user_type_id`, `is_verified`, `verification_code`, `random_code`, `created_at`, `updated_at`) VALUES
(1, 'rush', '698d51a19d8a121ce581499d7b701668', 2, 1, NULL, NULL, NULL, NULL),
(7, 'rushik', '96e79218965eb72c92a549dd5a330112', 4, 0, 'xrn5ixno', NULL, 1548052131, 1548052131);
